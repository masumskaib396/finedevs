...
class FinestDevs_CSS_Transform {
	...
	public static function register( Element_Base $element ) {
		$element->start_controls_section(
			'finestdevs_section_css_transform',
			[
				'label' => __( 'FinestDevs CSS Transform', 'finestdevs' ),
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Translate X', 'finestdevs' ),
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Translate Y', 'finestdevs' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$element->add_control(
			...
			[
				'label' => __( 'Mode', 'finestdevs' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'compact' => [
						'title' => __( 'Compact', 'finestdevs' ),
						'icon' => 'eicon-plus-circle',
					],
					'loose' => [
						'title' => __( 'Loose', 'finestdevs' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Transition Duration', 'finestdevs' ),
				'type' => Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units' => ['px'],
				'range' => [
