...
class Finestdevs_Container_Extras
{
	...
	public function __construct()
	{
		...
		add_action("elementor/element/after_section_end", array($this, 'finestdevs_section_add_extra_controls'), 19, 3);
	}


	public function finestdevs_section_add_extra_controls($widget, $section_id, $args)
	{
		...
		$widget->start_controls_section(
			'finestdev_section_advanced_container_extra',
			array(
				'label'     => __('Element Control by FinestDevs','finestdev'),
...
Finestdevs_Container_Extras::get_instance();
